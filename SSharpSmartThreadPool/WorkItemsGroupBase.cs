...
namespace Amib.SSharpThreading.Internal
	...
	public abstract class WorkItemsGroupBase : IWorkItemsGroup
		...
		public IWorkItemResult QueueWorkItem<T1, T2, T3, T4> (Action<T1, T2, T3, T4> action, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
			{
			return QueueWorkItem (action, arg1, arg2, arg3, arg4, SmartThreadPool.DefaultWorkItemPriority);
			}
		...
		public IWorkItemResult<TResult> QueueWorkItem<TResult> (Func<TResult> func)
			{
			return QueueWorkItem (func, SmartThreadPool.DefaultWorkItemPriority);
			}

		public IWorkItemResult<TResult> QueueWorkItem<TResult> (Func<TResult> func, WorkItemPriority priority)
			{
			PreQueueWorkItem ();
			WorkItem workItem = WorkItemFactory.CreateWorkItem (
							this,
		...
		public IWorkItemResult<TResult> QueueWorkItem<T, TResult> (Func<T, TResult> func, T arg)
			{
			return QueueWorkItem (func, arg, SmartThreadPool.DefaultWorkItemPriority);
			}

		public IWorkItemResult<TResult> QueueWorkItem<T, TResult> (Func<T, TResult> func, T arg, WorkItemPriority priority)
			{
			PreQueueWorkItem ();
			WorkItem workItem = WorkItemFactory.CreateWorkItem (
				this,
		...
		public IWorkItemResult<TResult> QueueWorkItem<T1, T2, TResult> (Func<T1, T2, TResult> func, T1 arg1, T2 arg2)
			{
			return QueueWorkItem (func, arg1, arg2, SmartThreadPool.DefaultWorkItemPriority);
			}

		public IWorkItemResult<TResult> QueueWorkItem<T1, T2, TResult> (Func<T1, T2, TResult> func, T1 arg1, T2 arg2, WorkItemPriority priority)
			{
			PreQueueWorkItem ();
			WorkItem workItem = WorkItemFactory.CreateWorkItem (
							this,
		...
		public IWorkItemResult<TResult> QueueWorkItem<T1, T2, T3, TResult> (Func<T1, T2, T3, TResult> func, T1 arg1, T2 arg2, T3 arg3)
			{
			return QueueWorkItem (func, arg1, arg2, arg3, SmartThreadPool.DefaultWorkItemPriority);
			}

		public IWorkItemResult<TResult> QueueWorkItem<T1, T2, T3, TResult> (
			Func<T1, T2, T3, TResult> func, T1 arg1, T2 arg2, T3 arg3, WorkItemPriority priority)
			{
			PreQueueWorkItem ();
			WorkItem workItem = WorkItemFactory.CreateWorkItem (
							this,
		...
		public IWorkItemResult<TResult> QueueWorkItem<T1, T2, T3, T4, TResult> (Func<T1, T2, T3, T4, TResult> func, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
			{
			return QueueWorkItem (func, arg1, arg2, arg3, arg4, SmartThreadPool.DefaultWorkItemPriority);
			}

		public IWorkItemResult<TResult> QueueWorkItem<T1, T2, T3, T4, TResult> (
			Func<T1, T2, T3, T4, TResult> func, T1 arg1, T2 arg2, T3 arg3, T4 arg4, WorkItemPriority priority)
			{
			PreQueueWorkItem ();
			WorkItem workItem = WorkItemFactory.CreateWorkItem (
							this,
